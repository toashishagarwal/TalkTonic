...
class VoiceAssistantApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Talk Tonic- Your AI Voice Assistant")
        ...
        self.add_message("Hello! I'm your AI voice assistant. Click the microphone to start speaking.", "assistant")
    ...
    def add_message(self, message, sender):
        ...
        # Update the conversation history for the OpenAI context
    ...
    def generate_and_speak_response(self, user_input):
        """Generate a response using OpenAI and speak it."""
        try:
            # Generate response
    ...
    def generate_openai_response(self, input_text):
